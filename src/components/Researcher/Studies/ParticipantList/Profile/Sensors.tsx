...
export default function Sensors({ participant, study, ...props }: { participant: any; study: any }) {
    ...
    <Box width={1}>
      <Box display="flex" width={1} mt={5}>
        ...
        <Box className={classes.secAdd}>
          <AddSensor studyId={participant.study_id} setSensors={onChangeSensors} study={study} />
        </Box>
      </Box>
