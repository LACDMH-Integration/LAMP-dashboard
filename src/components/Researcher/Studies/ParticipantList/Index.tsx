...
export default function ParticipantList({
  ...
  useInterval(
    ...
    participants !== null &&
      (((study?.participant_count || 0) > 0 && participants.length > 0) || (study?.participant_count || 0) === 0)
      ? null
      : 2000,
    true
  )
  ...
  const searchParticipants = (searchVal?: string) => {
    ...
    let result = []
    setLoading(true)
    Service.getDataByKey("participants", [selectedStudy], "study_id").then((participantData) => {
