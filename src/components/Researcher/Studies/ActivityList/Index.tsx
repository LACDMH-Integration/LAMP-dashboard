...
export default function ActivityList({ researcher, title, selectedStudy, study, ...props }) {
  ...
  const searchActivities = (searchVal?: string) => {
    ...
    let result = []
    setLoading(true)
    Service.getDataByKey("activities", [selectedStudy], "study_id").then((activitiesData) => {
